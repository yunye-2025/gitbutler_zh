...
{#if canShowPrompt}
	...
	<div class="forge-prompt">
		...
		<h3 class="text-13 text-body text-bold">检测到你有 {forgeLabel} 远程！</h3>
		<p class="text-12 text-body m-b-8 clr-text-2">
			GitButler 可以在应用内直接为你显示、创建并管理 {forgeUnit}。
			<Link href={integrationDocs}>了解更多</Link>
		</p>

		<div class="forge-prompt__footer">
			<Button kind="outline" onclick={dismissPrompt}>忽略</Button>
