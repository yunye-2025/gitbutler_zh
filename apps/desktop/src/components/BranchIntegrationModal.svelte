...
<Modal bind:this={modalRef} title="集成上游更改" noPadding width={500}>
	...
	<ModalFooter>
		<Button kind="outline" type="reset" onclick={closeModal}>取消</Button>
		<Button
			style="pop"
			type="submit"
			onclick={handleIntegrate}
			loading={integrating.current.isLoading}>集成更改</Button
		>
	</ModalFooter>
</Modal>
