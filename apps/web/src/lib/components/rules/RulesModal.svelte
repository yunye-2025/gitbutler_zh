...
<Modal bind:this={modal} title="创建规则" onSubmit={createRule}>
	<div class="rules-modal-wrapper">
		<ScrollableContainer whenToShow="hover">
			<div class="rules-modal">
				<p class="text-16">填写要创建的规则信息</p>
				{@render titleInput()}
				{@render descriptionInput()}
				{#if shouldShowExample}
					<p class="text-14">示例</p>
	...
	{#snippet controls(close)}
		...
		<Button style="pop" type="submit" loading={isGenerating}>创建规则</Button>
	{/snippet}
</Modal>
