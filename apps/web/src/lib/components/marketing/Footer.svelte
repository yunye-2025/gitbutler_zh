	...
	<div class="banner" class:no-downloads={!showDownloadLinks}>
		{#if showDownloadLinks}
			<div class="banner-content-downloads">
				<div class="stack-v">
					<h2 class="banner-title">下载<i>应用</i></h2>
					...
					<div class="download-links">
						...
						<div class="download-category">
							...
							<div class="download-options">
								<a href={jsonLinks.downloads.linuxAppimage.url} class="download-link">AppImage 包</a>
								<a href={jsonLinks.downloads.linuxDeb.url} class="download-link">DEB 包</a>
								<a href={jsonLinks.downloads.linuxRpm.url} class="download-link">RPM 包</a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="banner-nightly-text">
					<span class="opacity-50">抢先体验 GitButler 最新功能。</span>
					<a href="/nightly" class="nightly-link">获取夜间版</a>
				</div>
			</div>
		{:else}
			<div class="banner-content-downloads">
		...
		<div class="stack-v gap-20">
			<div class="meta-links">
				<span class="meta-links__copyright"
					>©{new Date().getFullYear()} GitButler。保留所有权利。</span
				>
