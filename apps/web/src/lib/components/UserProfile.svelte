	...
	<div class="content-columns">
		<div class="main-column">
			...
			<div class="section-card readme-section">
				<div class="readme-header">
					<h2 class="section-title-only">自述文件</h2>
					{#if isCurrentUser}
				...
				<div class="readme-content">
					{#if editingReadme}
						<textarea
							...
							class="readme-editor"
							rows="15"
							placeholder="请输入自述文件的 Markdown 内容…"
							disabled={isSavingReadme}
						></textarea>
		...
		<div class="side-column">
			...
			<div class="section-card profile-card">
				{#if user.avatarUrl}
					<img src={user.avatarUrl} alt="{user.name} 的头像" class="sidebar-avatar" />
				{/if}
			...
			{#if hasContactInfo(user)}
				<div class="section-card contact-info-section">
					<h2 class="section-title">联系方式与信息</h2>
