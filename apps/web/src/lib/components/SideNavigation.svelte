...
<div class="navigation">
	<div class="domains">
		<a href="/" class="main-nav" aria-label="主导航" title="首页">
			<svg
		...
		{#if $user}
			<a class="nav-link nav-button" href="/organizations" aria-label="组织">
				<svg
					xmlns="http://www.w3.org/2000/svg"
					width="16"
					height="16"
	...
	<div class="nav__bottom">
		...
		<a class="nav-link nav-button" href="/downloads" aria-label="下载" title="下载">
			<svg
				xmlns="http://www.w3.org/2000/svg"
				width="16"
				height="16"
