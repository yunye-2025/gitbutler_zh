	...
	<div class="latest-release">
		<div class="latest-release__header">
			...
			<div class="latest-release__header-labels">
				...
				<div class="latest-release__header-subtitle">
					...
					<span> • </span>
					<span
						>{new Date(latestRelease.released_at).toLocaleDateString('zh-CN', {
							day: 'numeric',
							month: 'long',
							year: 'numeric'
						})}</span
				...
				<div class="download-category">
					...
					<div class="download-options">
						{#if latestReleaseBuilds.darwin_x86_64}
							<a href={latestReleaseBuilds.darwin_x86_64.url} class="download-link">
								Intel Mac 版
							</a>
						{/if}
		...
		<div class="nightly-info">
			<p class="text-14 text-body clr-text-2">
				抢先体验 GitButler 最新功能。⋆˚₊
				<a href="/nightly" class="download-link">获取夜间版</a>
				☽˚.⋆
			</p>
		</div>
