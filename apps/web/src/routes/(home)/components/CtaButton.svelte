...
>
	<div class="download-btn__title">
		<span class="download-btn__title">下载适用于 {detectedOS}</span>
	...
	<span class="download-btn__version">公开测试版 {$latestClientVersion}</span>
...
<a class="download-btn mobile" href={jsonLinks.resources.downloads.url}>
	<div class="download-btn__title">
		<span class="download-btn__title">下载<i>应用</i></span>
	</div>
	<span class="download-btn__version">公开测试版 {$latestClientVersion}</span>
