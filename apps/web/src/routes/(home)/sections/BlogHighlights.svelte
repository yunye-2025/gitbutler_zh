<script lang="ts">
	...
	async function fetchRSSFeed() {
		try {
			...
			const creator = authorMatch ? authorMatch[1] : 'GitButler 团队';
			...
			<div class="blog-post__content">
				<div class="blog-post__header">
					...
					<span class="blog-post__meta">
						{formatDate(posts?.[0]?.published_at ?? '')} · 作者 {posts?.[0]?.primary_author?.name}
					</span>
				</div>
			...
			<a href={posts?.[1]?.url} class="blog-post blog-post--secondary">
				...
				<div class="blog-post__content">
					<div class="blog-post__header">
						...
						<span class="blog-post__meta">
							{formatDate(posts?.[1]?.published_at ?? '')} · 作者 {posts?.[1]?.primary_author?.name}
						</span>
					</div>
					<div class="blog-post__body">
			...
			<a href={posts?.[2]?.url} class="blog-post blog-post--secondary">
				...
				<div class="blog-post__content">
					<div class="blog-post__header">
						...
						<span class="blog-post__meta">
							{formatDate(posts?.[2]?.published_at ?? '')} · 作者 {posts?.[2]?.primary_author?.name}
						</span>
					</div>
					<div class="blog-post__body">
