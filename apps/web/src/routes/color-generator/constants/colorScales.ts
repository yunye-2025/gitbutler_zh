...
export const SCALES: ColorScale[] = [
	{ name: '灰色', id: 'gray', baseHue: 25 },
	{ name: '强调色（青绿）', id: 'pop', baseHue: 180 },
	{ name: '错误（红）', id: 'danger', baseHue: 8 },
	{ name: '警告（橙）', id: 'warn', baseHue: 35 },
	{ name: '成功（绿）', id: 'safe', baseHue: 155 },
	{ name: '紫色', id: 'purple', baseHue: 270 }
];
...
export const SEMANTIC_ZONES: SemanticZone[] = [
	{ label: '背景', range: '100-90' },
	{ label: '柔和', range: '80-60' },
	{ label: '实色', range: '50-40' },
	{ label: '文本', range: '30-0' }
];
