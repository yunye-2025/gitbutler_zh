...
<div class="page-container">
	<header class="page-header">
		...
		<p class="page-description">管理你的组织及团队协作设置</p>
	</header>
									...
									<div class="organization-card">
										...
										<div class="organization-info">
											...
											<div class="organization-stats">
												<div class="stat">
													<Icon name="profile" />
													<span>{getOrganizationMembersCount(organization)} 名成员</span>
												</div>
												<div class="stat">
													<Icon name="search" />
													<span>{getOrganizationProjectsCount(organization)} 个项目</span>
												</div>
											</div>
										</div>
									</div>
	...
	<div class="join-section">
		<div class="join-card">
			<h3 class="join-title">加入组织</h3>
			<p class="join-description">有邀请码？加入已有组织。</p>
			<Button style="pop" onclick={() => joinOrganizationModal?.show()}>加入组织</Button>
		</div>
	</div>
</div>
