<script lang="ts">
	...
	const DESCRIPTION_PLACE_HOLDER = '未提供提交信息描述';
...
<svelte:head>
	{#if isFound(patchCommit?.current)}
		...
		<meta property="og:title" content="评审：{patchCommit.current.value?.title}" />
		<meta property="og:description" content={patchCommit.current.value?.description} />
	{:else}
		<title>GitButler 评审</title>
				...
				<div class="review-main" class:expand={chatMinimizer.value}>
					...
					<div class="review-main__meta">
						...
						<div class="review-main-description">
							<span class="text-12 review-main-description__caption">提交信息：</span>
